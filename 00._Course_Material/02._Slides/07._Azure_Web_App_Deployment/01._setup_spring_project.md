...
Move all files and folders (except for `.idea` and `.gitignore`) from the subfolder to the root of the repository.

Delete the subfolder created by the Spring Initializr. It should only contain `.idea` and `.gitignore` when you delete it.
