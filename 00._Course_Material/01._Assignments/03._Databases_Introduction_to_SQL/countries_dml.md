...
**Hand-in**: GitHub classroom assignment (Remember to check your email after you accept the assignment)
...
0. The `INSERT` statements are out of order. Can you sort them? (Not a SQL question but relates to week 1). You are allowed to temporarily cut out the top first and read them.

1. Run the SQL file so that a new database is created named `world_countries`.

2. How many countries are there? How did you query it to find out?
...
6. **Bonus question**: Delete 'Langbortistan' from the database.
